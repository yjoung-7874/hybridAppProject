...
Blockly.Blocks.lists_create_with={
  ...
  updateShape_:function(){
    ...
    this.itemCount_||this.getInput("EMPTY")||this.appendDummyInput("EMPTY").appendField(Blockly.Msg.LISTS_CREATE_EMPTY_TITLE);
...
Blockly.Blocks.lists_getIndex={
  init:function(){
    ...
    this.setTooltip(function() {
      ...
      switch(c+" "+d) {
        case "GET FROM_START":
        case "GET FROM_END":e=Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM;
        break;
        case "GET FIRST":e=Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST;
        break;
        case "GET LAST":e=Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST;
        break;
        case "GET RANDOM":e=Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM;
        break;
      ...
      if("FROM_START"==d||"FROM_END"==d) e+="  "+("FROM_START"==d?Blockly.Msg.LISTS_INDEX_FROM_START_TOOLTIP:Blockly.Msg.LISTS_INDEX_FROM_END_TOOLTIP)
    ...
    updateAt_:function(a){
      ...
      var d="FROM_START"==c||"FROM_END"==c;
        if(d!=a) {
          ...
          e.updateAt_(d);
          e.setFieldValue(c,"WHERE");return null
        }
      });
      ...
      Blockly.Blocks.lists_setIndex={
        init:function(){
          ...
          updateAt_:function(a){this.removeInput("AT");
          this.removeInput("ORDINAL",!0);
          ...
          this.getInput("ORDINAL")&&this.moveInputBefore("ORDINAL","TO");this.getInput("AT").appendField(b,"WHERE")
        }
      };
